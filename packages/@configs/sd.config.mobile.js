/**
 * Style Dictionary Configuration for Mobile Platform (v5 API)
 *
 * This file configures Style Dictionary to transform design tokens from JSON
 * into mobile-specific formats (JS/TS theme modules).
 */
